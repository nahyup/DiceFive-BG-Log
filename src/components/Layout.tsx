...
import { LayoutDashboard, Library, PenSquare, BarChart3, Dice5, Dices, Download, Upload, Users, Menu, X, Sparkles } from 'lucide-react';
...
export default function Layout() {
  ...
  const navItems = [
    ...
    { to: '/story', icon: Sparkles, label: 'Story' },
  ];
